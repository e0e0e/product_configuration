...
<div class="container">
	...
	<form method="post"
		...
		<label>Feature Name:</label><br /> <input type="text"
			class="text-dark" name="name" value="${feature.name}"><br />
		...
		<br /> <label>Feature Image:</label><br /> <input type="text"
			class="text-dark" name="imagePath" value="${feature.imagePath}"><br />

		<label>Price:</label><br /> <input type="text"
			class="text-dark" name="price" value="${feature.price}"><br />
		<label>Index:</label><br /> <input type="text"
			class="text-dark" name="index" value="${feature.index}"><br />
