...
<div class="container">
	...
	<form
		...
		<br />
		<a href="/im/${productFeature.imagePath}" target="_blank" class="rys float-right">
		<img src="/im/${productFeature.imagePath}" alt="Flowers in Chania" width="200" onerror="imgError(this)"></a>
		<br />
