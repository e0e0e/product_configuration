...
<div class="container">
	...
	<h3>
		Orders:<a href="/order/add" class="btn btn-outline-dark btn-sm"> <span
	...
	<c:forEach var="order" items="${orders}">
		...
		<div class="card text-dark bg-light m-1">
			...
			<div class="card-header bg-info text-left text-light">
				<div>Order name: ${order.orderName}, Price: ${order.price}, Client Address: ${order.client}, Units: ${order.unitsToProduce}</div> <a class="btn btn-outline-info text-dark"
					...
					<c:forEach var="feature" items="${order.orderFeatures}">
						...
						<div>
							<a class="btn btn-outline-info text-dark"
								href="/feature/editFeature?featureId=${feature.id}">${feature.productFeature.name}
