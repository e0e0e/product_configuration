...
<div>
    ...
    <div id="toc_container">
        ...
        <ul class="toc_list">
            ...
            <li><a href="#Ninth_Point_Header">9. Edycja wielu produktów,
                    MultiEdit</a></li>
            <ul>
                <li><a href="#Ninth_Sub_Point_1">9.1 Dodawanie opcji do wielu produktów</a></li>
                <li><a href="#Ninth_Sub_Point_2">9.1 Usunięcie opcji z wielu produktów</a></li>
            </ul>
            <li><a href="#Tenth_Point_Header">10. Baza danych</a></li>
            <ul>
                <li><a href="#Tenth_Sub_Point_1">10.1 Export bazy danych do pliku</a></li>
                <li><a href="#Tenth_Sub_Point_2">10.2 Wczytanie bazy danych z pliku</a></li>
            </ul>

            <li><a href="#Eleventh_Point_Header">11. Import z Matrixa</a></li>
            <ul>
                <li><a href="#Eleventh_Sub_Point_1">11.1 Wczytanie pliku Matrixa na server</a></li>
                <li><a href="#Eleventh_Sub_Point_2">11.2 Wczytanie informacji dla zamówienia z Matrixa</a></li>
            </ul>
    ...
    <div>
        ...
        <div>
            ...
            <img class="helpimg" src="/im/editselect.png" alt="Flowers in Chania" onerror="imgError(this)"> <img
                class="helpimg" src="/im/editselect2.png" alt="Flowers in Chania" onerror="imgError(this)">
    ...
    <div>
        ...
        <img class="helpimg" src="/im/gift2.png" alt="Flowers in Chania" onerror="imgError(this)">
        ...
        <img class="helpimg" src="/im/gift3.png" alt="Flowers in Chania" onerror="imgError(this)">
        ...
        <img class="helpimg" src="/im/gift4.png" alt="Flowers in Chania" onerror="imgError(this)">
        ...
        <img class="helpimg" src="/im/gift5.png" alt="Flowers in Chania" onerror="imgError(this)">
    ...
    <div>
        ...
        <img class="helpimg" src="/im/nostd2.png" alt="Flowers in Chania" onerror="imgError(this)">
        ...
        <img class="helpimg" src="/im/nostd3.png" alt="Flowers in Chania" onerror="imgError(this)">

        <div class="opis">Jeżeli klikniemy dyskietkę, a jakaą opcja
            będzie opisana jako niestandardowa, dostaniemy o tym komunikat.</div>

        <img class="helpimg" src="/im/nostd7.png" alt="Flowers in Chania" onerror="imgError(this)">
        ...
        <img class="helpimg" src="/im/nostd4.png" alt="Flowers in Chania" onerror="imgError(this)">

        <div class="opis">Jeśli zapis przebieg poprawnie dostaniemy
            komunikat ze taka konfiguracja produktu juz istnieje.</div>

        <img class="helpimg" src="/im/nostd5.png" alt="Flowers in Chania" onerror="imgError(this)">


        <div class="opis">Po powrocie do poprzedniej strony zamówienie
            już nie będzie opisane jako "No standard"</div>

        <img class="helpimg" src="/im/nostd6.png" alt="Flowers in Chania" onerror="imgError(this)">
    ...
    <div>
        ...
        <div>
            ...
            <img class="helpimg" src="/im/product1.png" alt="Flowers in Chania" onerror="imgError(this)">
            ...
            <img class="helpimg" src="/im/pattern1.png" alt="Flowers in Chania" onerror="imgError(this)">
            ...
            <img class="helpimg" src="/im/product2.png" alt="Flowers in Chania" onerror="imgError(this)">
        </div>
        <div>
            ...
            <img class="helpimg" src="/im/product3.png" alt="Flowers in Chania" onerror="imgError(this)">
    ...
    <div>
        ...
        <div>
            ...
            <img class="helpimg" src="/im/color1.png" alt="Flowers in Chania" onerror="imgError(this)">
        </div>
        <div>
            ...
            <img class="helpimg" src="/im/color3.png" alt="Flowers in Chania" onerror="imgError(this)">
        ...
        <div>
            ...
            <img class="helpimg" src="/im/color2.png" alt="Flowers in Chania" onerror="imgError(this)">
    ...
    <div>
        ...
        <img class="helpimg" src="/im/cecha2.png" alt="Flowers in Chania" onerror="imgError(this)">
        <div>
            ...
            <img class="helpimg" src="/im/pf1.png" alt="Flowers in Chania" onerror="imgError(this)">
            ...
            <img class="helpimg" src="/im/pf2.png" alt="Flowers in Chania" onerror="imgError(this)">
            ...
            <img class="helpimg" src="/im/pf3.png" alt="Flowers in Chania" onerror="imgError(this)">
        </div>
        ...
        <div>
            ...
            <img class="helpimg" src="/im/pf4.png" alt="Flowers in Chania" onerror="imgError(this)">

            <div class="opis">Szukamy odpowiedniej cechy, w tym przypadku
                jedziemy na sam dół i klikamy strzałkę skierowaną do góry.</div>

            <img class="helpimg" src="/im/pf5.png" alt="Flowers in Chania" onerror="imgError(this)">
            ...
            <img class="helpimg" src="/im/pf6.png" alt="Flowers in Chania" onerror="imgError(this)">
        ...
        <div>
            ...
            <img class="helpimg" src="/im/pf7.png" alt="Flowers in Chania" onerror="imgError(this)">
        ...
        <div>
            ...
            <img class="helpimg" src="/im/pf8.png" alt="Flowers in Chania" onerror="imgError(this)">
            ...
            <img class="helpimg" src="/im/pf9.png" alt="Flowers in Chania" onerror="imgError(this)">
        </div>
    </div>
    <div>
        ...
        <img class="helpimg" src="/im/f1.png" alt="Flowers in Chania" onerror="imgError(this)">
        ...
        <div>
            ...
            <img class="helpimg" src="/im/f2.png" alt="Flowers in Chania" onerror="imgError(this)">
        </div>
        <div>
            ...
            <img class="helpimg" src="/im/f3.png" alt="Flowers in Chania" onerror="imgError(this)">
    ...
    <div>
        ...
        <div class="opis">W celu ułatwienia edycji i przeglądania już
            ...
            jednocześnie. Po wybraniu rządanych wartości filtra, należy kliknąć przycisk "Search".</div>

        <img class="helpimg" src="/im/multi1.png" alt="Flowers in Chania" onerror="imgError(this)">

        <div class="opis">Jeśli przefiltrujemy tylko po rozmiarze koła 385/65 R22,5, zobaczymy dużą tabelę z wszystkimi
            cechami produktów.</div>

        <img class="helpimg" src="/im/multi2.png" alt="Flowers in Chania" onerror="imgError(this)">

        <div class="opis">Następnie klikając na kafelki "Wheels" i "Tires", przefiltrujemy wyświetlaną zawartość,
            tak aby były widoczne tylko interesujące nas cechy.
            Należy zwrócić uwagę na wartość przy "Edit in all products in:", jeżeli ostatnim klikniętym kafelkiem
            była cecha "Tires" taka tam się wyświetli. Oznacza to, że jak klikniemy przyciski "Add feature", do
            takiej cechy w wyświetlonych produktach, będzie można dodać wybraną opcja. Jak klikniemy "Remove
            feature", będzie można usunąć z tej cechy wybraną opcję. "Show all" resetuje widok do wszystkich widocznych
            cech, przydatne gdy wybierzemy za dużo lub chcemy sprawdzić coś innego.</div>

        <img class="helpimg" src="/im/multi3.png" alt="Flowers in Chania" onerror="imgError(this)">

        <div>
            <h2 id="Ninth_Sub_Point_1">9.1 Dodawanie opcji do wielu produktów</h2>

            <div class="opis">Jeżeli przefiltrujemy opcję jak w punkcie powyżej możemy dodać np., nowy rodzaj opony do
                wszystkich produktów, w których jest użyta odpowiednia opona.

            </div>

            <img class="helpimg" src="/im/multi4.png" alt="Flowers in Chania" onerror="imgError(this)">

            <div class="opis">Po kliknięciu przycisku "Add feature" pojawi się menu w którym możemy wybrać opcję jaką
                chcemy dodać.
                Opcje są wyświetlane na podstawie wszystkich produktów dotychczas skonfigurowanych. Czyli jak mamy
                zupełnie nową opcję, którą chcemy dodać. Musimy skonfigurować najpierw co najmniej jeden produkt z tą
                opcją, aby mogła się pojawic na tej liście.
            </div>

            <img class="helpimg" src="/im/multi5.png" alt="Flowers in Chania" onerror="imgError(this)">

            <div class="opis">Po dodaniu, dodana opcja będzie zaznaczona na kolor żółty. Po odświeżeniu strony zostaną
                zaczytane opcje na nowo i w standardowym kolorze.
            </div>

            <img class="helpimg" src="/im/multi8.png" alt="Flowers in Chania" onerror="imgError(this)">
        ...
        <div>
            ...
            <div class="opis">Po kliknięciu przycisku "Remove feature".
            </div>

            <img class="helpimg" src="/im/multi7.png" alt="Flowers in Chania" onerror="imgError(this)">


            <div class="opis">Po usunięcieu, usunięta opcja będzie zaznaczona na kolor czerwony z przekreślonym tekstem.
                Po odświeżeniu strony zostaną
                zaczytane opcje na nowo, już bez tych opcji. Jeżeli usuwana opcja jest jedyną zdefiniowaną w produkcie,
                nie zostanie usunięta!
                Należy najpierw dodać inną, która pozostanie po usunięciu.
            </div>

            <img class="helpimg" src="/im/multi6.png" alt="Flowers in Chania" onerror="imgError(this)">
    ...
    <div>
        ...
        <div class="opis"> Przy wykonywaniu operacji na bazie danych należy mieć świadomość, że inni użytkownicy mogą
            pracować w tym samym czasie na obecnej bazie danych.
            Wczytanie starej bazy danych powoduje utratę danych, które były wprowadzone przed jej exportem. Zaleca się
            robienie kopi zapasowej bazy danych co jakiś czas, lub przy wprowadzaniu większych zmian do konfiguracji
            produktów. Należy unikać wczytywania bazy danych.
        </div>
        <div>
            <h2 id="Tenth_Sub_Point_1">10.1 Export bazy danych do pliku</h2>
            <div class="opis"> W celu zapisania aktualnej bazy danych należy kliknąc link "DB" z sybolem dyskietki ze
                szczałką skierowaną w dół.
                Po kliknięciu automatucznie zostanie pobrany plik o nazwie "db-dump.sql" do folderu domyślnego dla
                wszystkich pobieranych plików z przeglądarki, zwykle do folderu "Pobrane".
            </div>

            <img class="helpimg" src="/im/db1.png" alt="Flowers in Chania" onerror="imgError(this)">

        </div>

        <div>
            <h2 id="Tenth_Sub_Point_2">10.2 Wczytanie bazy danych z pliku</h2>
            <div class="opis">Przed wczytaniem bazy danych zaleca się zrobienie kopii aktualnej bazy danych. W celu
                wczytania zapisanej bazy danych należy kliknąc link "DB" z sybolem dyskietki ze
                szczałką skierowaną do góry.
                Ukaże się menu do inportu pliku, w którym należy kliknąć przycisk "Wybierz plik".
            </div>

            <img class="helpimg" src="/im/db2.png" alt="Flowers in Chania" onerror="imgError(this)">

            <div class="opis">Otworzy się okno gdzie możemy wybrać plik jaki chcemy wczytać.
            </div>

            <img class="helpimg" src="/im/db3.png" alt="Flowers in Chania" onerror="imgError(this)">

            <div class="opis">Po wybraniu pliku i wciśnięciu przycisku "Submit", pojawi się widok potwierdzający
                wczytanie tego pliku.
            </div>

            <img class="helpimg" src="/im/db4.png" alt="Flowers in Chania" onerror="imgError(this)">

        </div>

        <div>
            <h2 id="Eleventh_Point_Header">11. Import z Matrixa</h2>
            <div class="opis">Istnieje możliwość zaimportowania informacji z pliku sharpointa, z tzw. Matrixa.
                Wymaga to jednak zaimportowania aktualnego pliku do programu. Importowane wartości są ściśle powiązane z
                rozmieszczeniem kolumn w oryginalnym pliku, dodanie lub przesunięcie kolumn może wiązać się z tym, że
                nie będzie działać ten import poprawnie. Informację jakie można zaimportować to numery polskich zleceń i
                link do materiałów z sherpointa powiązanych z tym zamówieniem.
            </div>
            <img class="helpimg" src="/im/matrix1.png" alt="Flowers in Chania" onerror="imgError(this)">

            <div>
                <h2 id="Eleventh_Sub_Point_1">11.1 Wczytanie pliku Matrixa na server</h2>

                <div class="opis">Wczytanie pliku Matrixa wymaga zapisania go na swoim komputerze i następnym wczytaniu
                    go do programu.
                    Aby wczytać plik należy wybrać link "Matrix" z sybmolem dyskietki ze strzałką skierowaną ku górze, z
                    menu górnego.
                </div>
                <img class="helpimg" src="/im/matrix2.png" alt="Flowers in Chania" onerror="imgError(this)">

                <div class="opis">Następnie należy kliknąć przycisk "Wybierz plik" i wybrać zapisany na dysku plik
                    Matrixu, kliknąć "Otwórz", potwierdzić przyciskiem "Submit".
                    Pojawi się potwierdzenie wczytania pliku.
                </div>
                <img class="helpimg" src="/im/matrix3.png" alt="Flowers in Chania" onerror="imgError(this)">

                <div>
                    <h2 id="Eleventh_Sub_Point_2">11.2 Wczytanie informacji dla zamówienia z Matrixa</h2>

                    <div class="opis">Aby wczytać informację z Matrixa należy przejść do widoku szczegółowego zamówienia
                        i wybrać ikonę z symbolem magnesu.
                        Istotnę jest aby nazwa zamówienia w kolumnie C w pliku Matrixa była zgodna z nazwą zapisanego
                        zamówienia.
                    </div>
                    <img class="helpimg" src="/im/matrix4.png" alt="Flowers in Chania" onerror="imgError(this)">

                    <div class="opis">Po chwili jeżeli dane zostaną odnalezione i wczytane informację o numerach
                        polskich zleceń i linku do folderów z sharpointa pojawią się na widoku szczegółowym zamówienia.
                    </div>
                    <img class="helpimg" src="/im/matrix5.png" alt="Flowers in Chania" onerror="imgError(this)">
